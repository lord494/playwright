...
export class EldTypesPage extends BasePage {
    readonly page: Page;
    readonly addEldType: Locator;
    ...
    constructor(page: Page) {
        super(page);
        this.page = page;
        this.addEldType = page.locator('.mdi-plus');
    ...
    async fillTypeName(board: Locator, name: string): Promise<void> {
