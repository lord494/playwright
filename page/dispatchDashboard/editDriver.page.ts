...
export class EditDriver {
    ...
    constructor(page: Page) {
        ...
        this.trailerHistoryList = page.locator('.history-wraper');
    ...
    async returnOnPreviousState(): Promise<void> {
        ...
        await this.page.waitForLoadState('networkidle');
        await dashboard.fillInputField(dashboard.nameSearchInput, Constants.driverWalfredBlanco);
        const imeZaPretragu = Constants.driverWalfredBlanco;
        ...
        const nameText = dashboard.driverNameColumn.filter({ hasText: Constants.driverWalfredBlanco });
        ...
        await this.fillInputField(this.driverName, Constants.driverWayneJones);
