...
export class InsertPage extends BasePage {
    readonly page: Page;
    ...
    readonly addNewPermitButton: Locator;
    ...
    constructor(page: Page) {
        ...
        this.addNewPermitButton = page.locator('.v-btn__content', { hasText: 'Add new permit book' });
    }
    ...
    async enterTrailerNumber(menu: Locator, trailerNumber: string, option: Locator): Promise<void> {
        await this.fillAndSelectFromMenu(menu, trailerNumber, option);
    }
